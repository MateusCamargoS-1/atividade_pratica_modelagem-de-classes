...
class BombaCombustivel {
    ...
    // quantidade de combustível restante na bomba.
    // que foi colocada no veículo
    abastecerPorValor(valorAbastecimento) {
    ...
    abastecerPorLitro(qtdLitroAbastecer) {
        if (this.quantidadeCombustivelBomba >= qtdLitroAbastecer) {
            let valorTotal = (qtdLitroAbastecer * this.valorLitro).toFixed(2);
    ...
    alterarValor(valorAlterado) {
        this.valorLitro = valorAlterado;
    }
    alterarCombustivel(tipoCombustivelAlterado) {
        this.tipoCombustivel = tipoCombustivelAlterado;
    }
    alterarQuantidadeCombustivel(quantidadeCombustivelBombaAlterado) {
